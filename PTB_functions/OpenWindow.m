...
if ~isfield(display,'screenNum')
    display.screenNum = max(Screen('Screens'));%0
end
...
display.frameRate = 1/Screen('GetFlipInterval',display.windowPtr); 
display.ifi = Screen('GetFlipInterval',display.windowPtr,100,50e-6,10);
